...
exports.versionGuard = function(version) {
  if (version !== undefined) {
    console.log(
      'More than one instance of qtumscan-lib found.',
      'Please make sure to require qtumscan-lib and',
      'check that submodules do not also include their own qtumscan-lib dependency.'
    )
  }
}
exports.versionGuard(global._qtumscan)
global._qtumscan = exports.version
