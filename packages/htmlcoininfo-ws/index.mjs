...
import {Transaction, Address} from 'htmlcoininfo-lib'
import Service from 'htmlcoininfo-node/lib/services/base'

export default class HtmlcoininfoWebsocketService extends Service {
  constructor(options) {
    super(options)
  ...
  async start() {
    this._bus = this.node.openBus({remoteAddress: 'localhost-htmlcoininfo-ws'})
