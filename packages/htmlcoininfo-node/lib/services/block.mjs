...
import {Header as RawHeader, Block as RawBlock, Address, Solidity} from 'htmlcoininfo-lib'
...
export default class BlockService extends Service {
  ...
  async __onBlock(rawBlock) {
    ...
    let contractTransactionList = await HtmlcoinBalanceChanges.distinct('id', {
